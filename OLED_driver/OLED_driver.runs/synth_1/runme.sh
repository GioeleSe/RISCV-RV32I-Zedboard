...
HD_PWD='C:/Users/gioel/Documents/unitn/2_anno_2_semestre/advanced_logic_design_passerone/RISCV_on_Zedboard/OLED_driver/OLED_driver.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log oled_controller.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source oled_controller.tcl
