...
HD_PWD='C:/Users/gioel/Documents/unitn/2_anno_2_semestre/advanced_logic_design_passerone/RISCV_on_Zedboard/OLED_driver/OLED_driver.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log oled_controller.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source oled_controller.tcl -notrace
